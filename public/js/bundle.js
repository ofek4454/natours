    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alert.showAlert)('error', 'Error getting out! Try again.');
        case 10:
        case "end":
...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoib2ZlazQ0NTQiLCJhIjoiY2xxZ3RuMWtjMWJndzJpbWVobng1cWYydiJ9.TuemkyjIsQOUf_wyx1ZqOA';
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type == 'data' ? 'me' : 'updatePassword';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " was changed successfully!"));
          _context.next = 11;
          break;
        case 8:
          _context.prev = 8;
...
var accountPasswordForm = document.querySelector('.form-user-settings');
...
},{"./login":"login.js","./mapbox":"mapbox.js","./updateData":"updateData.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
